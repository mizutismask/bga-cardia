...
const GLB_NEXT_CARD_MODIFIER_AFTER_ABILITY_TRIGGERED_COUNTDOWN = 'nextCardModifAfterAbltyCounter'; //engineer with foggy swamp needs to wait for the second reveal and ability to be applied
