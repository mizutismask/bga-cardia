...
class Globals{
    function set(string $name, mixed $obj): void{}
    function get(string $name, mixed $defaultValue = null): mixed{return null;}
    function getAll(...$names): array{return [];}
    function delete(...$names): void {;}
    function has(string $name): bool{return true;}
    function inc(string $name, int $inc): int{return 0;}
}
